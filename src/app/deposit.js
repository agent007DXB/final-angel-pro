    ...
    <div ref={ModalRef} onClick={closeModal} className='fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center'>
        <div className='mt-10 flex flex-col gap-5 text-white'>
            ...
            <div className='bg-orange-600 rounded-xl px-20 py-10 flex flex-col gap-3 items-center mx-4'>
                ...
                <p className='font-bold max-w-md text-center'>If have transaction fee, don't forget to add it. The transfer amount must match the deposit amount</p>
                <form onSubmit={handleSubmit}>
                    ...
                    <br/><br/>
                    <p value={copyText} onChange={(e) => setCopytext(e.target.value)}>TXii93QZLLpFEWpz32WES1bJiWQDjnrD14 <button onClick={handleCopy}><Copy /></button> </p>
